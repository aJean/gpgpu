...
(function () {
    ...
    2: [function (require, module, exports) {
        ...
        }, { "../../core/utils": 32, "../function-node-base": 7 }],
    3: [function (require, module, exports) {
        ...
        }, { "../../core/utils": 32, "../kernel-run-shortcut": 9 }],
    4: [function (require, module, exports) {
        ...
        }, { "../../core/utils": 32, "../kernel-base": 8, "./kernel-string": 3 }],
    5: [function (require, module, exports) {
        ...
        }, { "../../core/utils": 32, "../runner-base": 10, "./function-builder": 1, "./kernel": 4 }],
    ...
    14: [function (require, module, exports) {
                                ...
                                case 'Array':
                                    {
                                        ...
                                        var _formatArrayTransfer2 = this._formatArrayTransfer(value, length), valuesFlat = _formatArrayTransfer2.valuesFlat, bitRatio = _formatArrayTransfer2.bitRatio;
                                        var buffer = void 0;
                                ...
                                case 'Input':
                                    {
                                        ...
                                        var _formatArrayTransfer3 = this._formatArrayTransfer(value.value, _length), _valuesFlat = _formatArrayTransfer3.valuesFlat, _bitRatio = _formatArrayTransfer3.bitRatio;
                                        if (this.floatTextures) {
        ...
        }, { "../../core/texture": 30, "../../core/utils": 32, "../kernel-base": 8, "./kernel-string": 13, "./shader-frag": 16, "./shader-vert": 17 }],
    15: [function (require, module, exports) {
        ...
        }, { "../runner-base": 10, "./function-builder": 11, "./kernel": 14 }],
    ...
    19: [function (require, module, exports) {
        ...
        }, { "../function-builder-base": 6, "./function-node": 20 }],
    ...
    21: [function (require, module, exports) {
                                ...
                                case 'Array':
                                    {
                                        ...
                                        gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.NEAREST);
                                        var length = size[0] * size[1];
                                        var _formatArrayTransfer = this._formatArrayTransfer(value, length), valuesFlat = _formatArrayTransfer.valuesFlat, bitRatio = _formatArrayTransfer.bitRatio;
                                        var buffer = void 0;
                                        if (this.floatTextures) {
                                ...
                                case 'Input':
                                    {
                                        ...
                                        gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.NEAREST);
                                        var _length = _size[0] * _size[1];
                                        var _formatArrayTransfer2 = this._formatArrayTransfer(value.value, _length), _valuesFlat = _formatArrayTransfer2.valuesFlat, _bitRatio = _formatArrayTransfer2.bitRatio;
                                        if (this.floatTextures) {
        ...
        }, { "../../core/texture": 30, "../../core/utils": 32, "../web-gl/kernel": 14, "./shader-frag": 23, "./shader-vert": 24 }],
    22: [function (require, module, exports) {
        ...
        }, { "../runner-base": 10, "./function-builder": 19, "./kernel": 21 }],
    ...
    28: [function (require, module, exports) {
            ...
            module.exports = GPU;
        }, { "../backend/cpu/runner": 5, "../backend/web-gl/runner": 15, "../backend/web-gl/validator-kernel": 18, "../backend/web-gl2/runner": 22, "../backend/web-gl2/validator-kernel": 25, "./gpu-core": 27, "./utils": 32 }],
    ...
    32: [function (require, module, exports) {
            ...
            var Utils = function (_UtilsCore) {
                ...
                _createClass(Utils, null, [{
                        ...
                        value: function clone(obj) {
                            if (obj === null || (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) !== 'object' || obj.hasOwnProperty('isActiveClone'))
                                return obj;
        ...
        }, { "../index": 33, "./input": 29, "./texture": 30, "./utils-core": 31 }],
